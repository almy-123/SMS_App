...
public class MessageReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        //SMS messages are retrieved from the intent's extra using hte key "pdus"
        ...
        try{
            if(bundle!=null){
                ...
                //Display in Toast
                Toast.makeText(context, "You received a message from: "+senderNum+",/n/n Message: "+message, Toast.LENGTH_LONG).show();
            }
        }catch(Exception e){
